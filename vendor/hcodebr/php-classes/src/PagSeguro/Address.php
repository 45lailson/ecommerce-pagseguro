...
class Address {
	...
	)
	{
		...
		if (!$street)
		{
			...
			throw new Exception("Informe o logradouro do endereco.");
		...
		if (!$number)
		{
			...
			throw new Exception("Informe o número do endereco.");
		...
		if (!$postalCode)
		{
			...
			throw new Exception("Informe o CEP do endereco.");
		...
		if (!$state)
		{
			...
			throw new Exception("Informe o estado do endereco.");
		...
		if (!$country)
		{
			...
			throw new Exception("Informe o pais do endereco.");
